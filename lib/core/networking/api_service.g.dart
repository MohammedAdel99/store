...
class _ApiService implements ApiService {
  ...
  @override
  Future<UploadImageResponse> upload(FormData file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = file;
  ...
  Future<List<GetProductResponse>> getAllProducts() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<GetProductResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<GetUserResponse>> getAllUser() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<GetUserResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => GetUserResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
